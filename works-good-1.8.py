...
3. INFORMATIONAL ("tell me about X", "what is X", "explain X"):
   - Reply in plain text with expert knowledge. No commands. Then <done>
...
{action_list}"""
            ...
            if actions:
                ...
                for idx, action in enumerate(actions, 1):
                    ...
                    if not obs["success"]:
                        self.console.print("[red]↑ Action failed — model will see this in next observation[/red]")
